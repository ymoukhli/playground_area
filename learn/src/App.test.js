...
// jest.mock('./app/utilitys/fetchData', () => {
//   return { fetchPopular: jest.fn(),
//   };
// })
...
//     screen.debug();
//     wrapper.update();
//     expect(wrapper.find(<Movie></Movie>).length).toEqual(20);
// });

//#region soso
// test('async render',async (done) => {
//   const resolve = [
//     {
//         "adult": false,
//         "backdrop_path": "/iQFcwSGbZXMkeyKrxbPnwnRo5fl.jpg",
...
//         "popularity": 1416.063,
//         "poster_path": "/dMVc0ilfy4193pnCo53W1bqG51v.jpg",
...
//     }
// ];
//   fetchPopular.mockResolvedValueOnce(resolve);
//   const wrapper = mount(<App></App>);
//   await act(async () => {
